-- 20260726290000 fixed two of the three unqualified "id" references that
-- collide with issue_my_certificate's implicit OUT variable "id" (from
-- RETURNS TABLE(id uuid, ...)), but missed one: the quiz_sessions subquery
-- used to count total questions ("where id = p_session_id") still throws
-- 42702 ("column reference \"id\" is ambiguous"). Qualifying it here.

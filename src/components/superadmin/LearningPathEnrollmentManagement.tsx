...
function EnrollmentModal({
  ...
  function onSubmit(ev: React.FormEvent) {
    ...
    if (saving) return;
    if (!validate()) return;
    // Only the target dimension matching enrollment_type should carry a
    ...
    // RLS tenant-scope column on every row regardless of enrollment_type,
    ...
    const cleaned = {
      ...form,
      company_id:     form.enrollment_type === 'company' ? form.company_id : (getCurrentUser()?.companyId ?? form.company_id),
      branch_id:      form.enrollment_type === 'branch'      ? form.branch_id      : null,
      department_id:  form.enrollment_type === 'department'  ? form.department_id  : null,
      designation_id: form.enrollment_type === 'designation' ? form.designation_id : null,
      employee_id:    form.enrollment_type === 'employee'    ? form.employee_id    : null,

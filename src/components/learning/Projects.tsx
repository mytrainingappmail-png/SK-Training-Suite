                ...
                {course.brochures.length > 0 && (
                  <div className="mt-4 grid grid-cols-1 gap-2 sm:grid-cols-2">
                    {course.brochures.map((b) => (
                      <div
                        key={b.resourceId}
                        className="flex items-center gap-3 rounded-xl border border-slate-200 bg-slate-50/60 p-3 transition hover:border-red-200 hover:bg-red-50/40"
                      >
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <p className="text-xs text-slate-400">PDF brochure</p>
                        </div>
                        <a
                          href={b.fileUrl}
                          target="_blank"
                          ...
                          download
                          className="inline-flex flex-shrink-0 items-center gap-1.5 rounded-lg bg-red-500 px-3 py-1.5 text-xs font-semibold text-white transition hover:bg-red-600 active:scale-95"
                        >

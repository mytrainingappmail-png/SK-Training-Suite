...
const DEFAULT_SETTINGS: Omit<QuizSettings, "company_id" | "updated_at"> = {
  ...
  cert_signatory1_scale: 100,
  cert_signatory1_name_scale: 100,
  cert_signatory2_name: null,
  cert_signatory2_title: null,
  cert_signatory2_image_url: null,
  cert_signatory2_scale: 100,
  cert_signatory2_name_scale: 100,
  cert_signature_mode: "both",
  cert_signature_align: "center",
  champ_music: "builtin",

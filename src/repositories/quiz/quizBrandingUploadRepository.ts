...
export type BrandingImageKind = "logo" | "login-background" | "login-banner" | "favicon" | "signatory-1" | "signatory-2" | "cert-logo" | "candidate-photo" | "question-image" | "cert-watermark-image";
